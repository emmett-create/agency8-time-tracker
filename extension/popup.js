// Agency 8 — Time Tracker popup.js                       
  ...
  const DEFAULT_CLIENTS = [                                                                                                                                                                                 
    ...
    'Feals','Fellow','Golden Age Fat','Ilia','Kind Patches','Lenox and Sixteenth','MadeGood',                                                                                                               
    'Magic Molecule','Magna','Masa','Merit','Momofuku','MPH','Nette','Roz','Skinfix','Snif',                                                                                                                
    'Squigs','SYS','Timebeam','TodayTix','Tushy','Vandy',                                                                                                                                                   
  ];                                                                                                                                                                                                        
                                                                                                                                                                                                            
  const DEFAULT_TASKS = [                                                                                                                                                                                   
    'Meetings','Sourcing','Strategy','Outreach','Reporting','Email','Admin',
    'LTK','Offboarding','Onboarding',                                                                                                                                                                       
  ];                                                                                                                                                                                                        
